	...
	public class InnerElement:Element
	{
		...
		public  ReplaceableString replaceInnerElements	( ReplaceableString replaceableString, int nestedCount )
		{
			...
			while ( match != null && match.Success ) {
				...
				string newText =  " _"+ this.GetType().Name.Substring(0,1) + this.GetType().Name.Substring(this.GetType().Name.Length-1,1) +  "_ " ;//TODO:revisar, pareciera que entre mas corto fallla menos // Ejem: "_InnerParenthesis_0_0_" //TODO: cambiarlo por un random
